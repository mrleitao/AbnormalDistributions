...
it also has to be pre-processed so that there are columns named "long" (latitude) and "lat" (longitude) if you want it to run right. the first line in this line of code in this chunk will open a file selecting window that wil let you import a .CSV to the workspace.
```{r import_crime_data}
